...
const HOOPBOARD_DATA = {
  ...
  scouting: {
    ...
    fenerbahce: {
      ...
      style: "Attaque de demi-terrain patiente orchestrée par Wade Baldwin, très fort volume au poste et sur le jeu à deux (pick-and-roll Baldwin–Birch). Défense agressive sur les lignes de passe qui cherche à déclencher la transition.",
      formeRecente: [
      ...
      pointsForts: [
        ...
        "Adresse extérieure des ailiers : Hayes-Davis et Hall shootent au-delà de 40 % à 3 pts.",
        "Pick-and-roll Baldwin–Birch quasi imparable en demi-terrain.",
        "Banc profond : l'intensité défensive ne baisse pas sur 40 minutes.",
      ],
      faiblesses: [
        "Vulnérable au jeu rapide : concède 16,2 pts en transition par match.",
        "Sous pression tout-terrain, le taux de pertes de balle grimpe (Wilbekin, Baldwin).",
        "Intérieurs qui fautent (Birch 3,4 fautes/match) : à attaquer dans le contact.",
        "Second rideau moins créatif quand Baldwin souffle (débuts de 2ᵉ et 4ᵉ QT).",
      ],
      joueursCles: [
        ...
        { nom: "Scottie Wilbekin",  poste: "Meneur",       taille: "1m88", num:  0, min: 25, pts: 13.1, reb: 2.4, pd: 3.9, tirsPct: 45.0, troisPct: 38.9, note: "Clutch : tir sur dribble, très dangereux en fin de match." },
        { nom: "Wade Baldwin IV",   poste: "Meneur",       taille: "1m93", num:  4, min: 27, pts: 12.3, reb: 3.1, pd: 5.8, tirsPct: 46.0, troisPct: 34.5, note: "Chef d'orchestre du pick-and-roll : cherche le tir de ses shooters." },
        { nom: "Khem Birch",        poste: "Pivot",        taille: "2m08", num: 24, min: 22, pts:  8.6, reb: 7.8, pd: 1.0, tirsPct: 62.0, troisPct:  0.0, note: "Ancre défensive et rebond : protège le cercle, roule vers le panier." },
      ...
      tendances: [
        "9 possessions sur 10 passent par un écran porteur : le pick-and-roll est leur base.",
        "Meilleur rebond offensif de la compétition (9,4/match) → beaucoup de secondes chances.",
        "Adresse à 3 pts en hausse sur les 10 derniers matchs (39,6 %).",
        "Défense qui force 7,1 interceptions/match mais concède des paniers faciles en repli.",
        "Invaincue à domicile sur ses 8 derniers matchs.",
      ],
      planMatch: {
        exploiter: [
          "Courir en transition avant que leur défense soit placée.",
          "Mettre Birch dans le pick-and-roll pour l'éloigner du cercle et le charger de fautes.",
          "Chercher le mismatch sur leurs meneurs quand ils défendent en switch.",
        ],
        eviter: [
          "Laisser filer des rebonds offensifs : boxer out systématiquement à 5.",
          "Prendre des tirs contestés tôt dans la possession qui lancent leur transition.",
          "Laisser Hall ou Hayes-Davis ouverts au corner.",
        ],
        prioritesDef: [
          "Contenir le pick-and-roll Baldwin–Birch : passer sous les écrans, protéger le cercle.",
