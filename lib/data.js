...
const HOOPBOARD_DATA = {
  ...
  /* ---- Séances à thème (ateliers spécifiques, pré-remplies pour la démo) ----
     Exemples de séances ciblées (tir à 3 pts, attaque de zone…) pour montrer au
     coach à quoi ressemble une séance spécialisée : objectif, joueurs, et zones
     de tir travaillées affichées sur le terrain (mêmes ids que court.js).
     Même forme que les séances manuelles → réutilise la fiche de séance. */
  seancesThematiques: {
    demo: true,
    seances: [
      {
        id: "th-tir-3pts", titre: "Tir à 3 points", type: "Tir", intensite: "Modérée",
        date: "2026-03-10", heure: "11:00", duree: 75, lieu: "Žalgiris Arena",
        objectif: "Catch & shoot et tir en sortie d'écran : gagner en adresse longue distance.",
        notes: "Séries de 100 tirs par zone, cadence match, avec contestation légère.",
        convoques: ["sylvain-francisco", "maodo-lo", "ignas-brazdeikis", "nigel-williams-goss", "edgaras-ulanovas", "dustin-sleva"],
        zones: ["three-corner-left", "three-corner-right", "three-wing-left", "three-wing-right", "three-top"],
      },
      {
        id: "th-attaque-zone", titre: "Attaque de zone", type: "Tactique", intensite: "Élevée",
        date: "2026-03-12", heure: "10:00", duree: 90, lieu: "Žalgiris Arena",
        objectif: "Casser la zone 2-3 : renversements rapides, surnombre et tir du corner.",
        notes: "Travail 5 contre 5 face à une zone, focus sur le timing des coupes et du skip-pass.",
        convoques: ["sylvain-francisco", "maodo-lo", "moses-wright", "azuolas-tubelis", "nigel-williams-goss", "ignas-brazdeikis"],
        zones: ["three-corner-left", "three-corner-right", "midrange-center", "short-corner-left", "short-corner-right", "paint-center"],
      },
      {
        id: "th-jeu-interieur", titre: "Jeu intérieur & rebond", type: "Physique", intensite: "Élevée",
        date: "2026-03-11", heure: "09:30", duree: 60, lieu: "Žalgiris Arena",
        objectif: "Finitions au contact et rebond offensif : imposer sa présence dans la raquette.",
        notes: "Duels 1 contre 1 dos au panier + boxout systématique sur chaque tir.",
        convoques: ["moses-wright", "azuolas-tubelis", "laurynas-birutis", "dustin-sleva", "edgaras-ulanovas"],
        zones: ["restricted-area-center", "paint-left", "paint-right", "short-corner-left", "short-corner-right"],
      },
      {
        id: "th-defense-aides", titre: "Défense collective & aides", type: "Défense", intensite: "Élevée",
        date: "2026-03-13", heure: "10:30", duree: 75, lieu: "Žalgiris Arena",
